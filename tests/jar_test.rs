...
fn jar_distributed_concept_full_lifecycle() {
    ...
    assert_eq!(entry.vector[0].current(), sig(1, 200).current());

    // =========================================================================
    // Phase 5: Recall via sparse query
    // =========================================================================

    let mut partial_cue = vec![Signal::ZERO; 64];
